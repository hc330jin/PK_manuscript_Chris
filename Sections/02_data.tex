...
$\pm 2.5$ min & 5min & 190.65 & 173.5 & 49.02 & 44 & 17,940 & 9.63\%\\
...
Transaction-quantity weighting is used only for these descriptive summaries. The baseline SVCJ calibration is not weighted by transaction quantity or by the number of trades in the window: after selecting one closest-to-08:00 transaction for each date--instrument pair, every retained option contract contributes one relative pricing residual to the least-squares objective.
