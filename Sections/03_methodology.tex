\subsection{Risk-neutral SVCJ specification}
...
\subsection{Simulation design for Q-parameter recovery}
...
=\left(V_0,\kappa,\theta,\sigma_v,\rho,\lambda,
       \mu_y,\sigma_y,\rho_J,\mu_v\right)^{\prime}
=\left(0.0009,0.7425,0.0008,0.0489,-0.6245,
       0.0033,0.3166,0.1267,-1.0821,0.0206\right)^{\prime}.
...
\subsection{Calibration and recovery criterion}
